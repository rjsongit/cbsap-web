...
GoodReceiptSelectTableGrid(): DynamicGridColumn[] {
  ...
  purchaseOrderDetailLineColumn(linkTemplate: TemplateRef<any>): DynamicGridColumn[] {
    return [
      {
        field: 'lineNumber',
        header: 'Line No',
      ...
      {
        field: 'goodReceiveAmount',
        header: 'Good Received Amount',
        sort: true,
        isSearchFilter: true,
        width: '200px'
      },
  ...
  dimensionSetupSearchColumn(): TableColumn[] {
    return [
      {
        field: 'dimensionSetupName',
        header: 'Dimension Setup Name',
        sort: false,
        isSearchFilter: true,
        type:"label"
      },
