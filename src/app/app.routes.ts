...
export const appRoutes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
    import('@layout/po-detail-layout/po-detail-layout.component').then(
      (m) => m.PODetailLayoutComponent
    ),
    children: [
      {
        path: '',
        loadComponent: () =>
          import('./modules/reference-data-lookup/po-reference/po-reference-detail/po-reference-detail.component').then((m) => m.PoReferenceDetailComponent),
      },
    ],
  },
  {
  ...
  {
    path: 'dimension-setup',
    component: ContentLayoutComponent,
    loadChildren: () =>
      import('@modules/settings/dimension-setup/dimension-setup.routes').then(
        (r) => r.DIMENSION_SETUP_ROUTES
      ),
  },
